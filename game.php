...
<style>
 ...
 <div class="header">
   ...
   <div class="instructions">
     <img src="instructions.png" align = "center" width = 360px height = 450px>
   </div>
   <div class="playbtn">
 ...
 <div class="one1">
   <div class="form-box">
    <div class="button-box">
     ...
     <form id="register" class="input-group" action ="game.php" method = "post">
       <input type="text" class="input-field" placeholder="User Id" name = "name" required>
       <input type="password" class="input-field" placeholder="Password" name = "password" required>
       <button type="submit" class="submit-btn2" name = "signup" value = "signup"><a href = "Game.html">Register</a></button>
     </form>
   </div>
 </div>
</div>
